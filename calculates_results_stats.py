...
def calculates_results_stats(results_dic):
    ...
    for key in results_dic:
        ...
        results_stats_dic['n_correct_notdogs'] += int(results_dic[key][3] == 0 and results_dic[key][4] == 0)
        results_stats_dic['n_correct_breed'] += int(results_dic[key][3] and results_dic[key][4])

    if results_stats_dic['n_dogs_img'] > 0:
        results_stats_dic['pct_match'] = (results_stats_dic['n_correct_dogs'] / results_stats_dic['n_dogs_img']) * 100.0
    if results_stats_dic['n_dogs_img'] > 0:
